  ...
  <div class="flex">
    ...
    <div class="p-3 sidebar z-30 bg-white h-full " :class="{ 'shadow-lg': isMobile }"
      ...
      <ul class="ml-3 mt-4">
        ...
        <li class="cursor-pointer  mb-2" @click="page = 24">4. Maintenance and Troubleshooting</li>
    ...
    <div class="flex-grow">
      <h2 v-if="loading" class="text-center text-[30px] mt-6">loading...</h2>
      <PDF :showPageTooltip="false" src="/files/qr-code/AHG-2285-CE-Instruction-Manual.pdf" :page="page"
