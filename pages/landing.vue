  ...
  <div class="flex flex-col">
    <div class="w-full bg-blackColor flex items-center justify-center h-[90vh] text-white">
      <div class="flex flex-col gap-5 lg:gap-0 container mx-auto relative">
        ...
        <h1 class="text-xl lg:my-5 leading-tight text-justify lg:max-w-[70%]" style="text-shadow: 7px 7px 5px rgba(0,0,0,0.5)">
          Delivering healthcare products <br class="hidden lg:block">
          that redefine your experience.
        </h1>
        <span class="text-tiny leading-tight text-justify lg:max-w-[60%] xl:max-w-[50%]">
        ...
        class="lg:absolute right-16 2xl:right-0 -bottom-1/2 img-shadow w-[60vw] md:w-[35vw] self-center max-w-[600px]"/>
      </div>
    </div>
    <div class="bg-lightColor py-[100px] w-full flex items-center justify-center">
      <div class="flex flex-col mx-auto container">
        ...
        <div class="w-full flex flex-col mt-[100px]">
          <div class="grid grid-cols-1 lg:grid-cols-2 place-items-center gap-y-8 gap-x-16">
      ...
      <div class="flex flex-col container mx-auto">
        ...
        <div class="mt-8 lg:mt-14 grid grid-cols-2 lg:grid-cols-4 gap-3 lg:-mx-20">
          <div class="bg-lightColor rounded-[30px] p-6 lg:px-10 xl:py-14 flex flex-col min-h-[40vw] gap-4">
            ...
            <div class="lg:hidden">
              <BaseAHGButton class="text-tiny ml-auto mt-4" color="black" is-show-more width="100%" py="0.5rem" text-size="0.8rem">
              <span>Learn More</span>
            </BaseAHGButton>
            </div>
          </div>
