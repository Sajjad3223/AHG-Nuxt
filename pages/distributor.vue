  ...
  <div class="flex flex-col">
    ...
    <div class="bg-blackColor py-[100px] flex justify-center items-center" >
      <div class="flex flex-col container mx-auto text-white">
        <h3 class="text-3xl text-center font-medium leading-tight">
          Join our <br>
          Distribution Network
        </h3>
        <form class="mt-24 grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
