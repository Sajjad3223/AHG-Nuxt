  ...
  <div class="flex flex-col">
    <div class="w-full bg-blackColor flex items-center justify-center h-[90vh] text-white">
      <div class="flex flex-col container mx-auto relative">
        ...
        <span class="text-sm 2xl:text-[36px] my-5 lg:my-10 leading-tight">
    ...
    <div class="py-[150px]">
      <div class="container mx-auto relative">
        <img src="../assets/images/world.png" alt="world" class="absolute -right-[10%] -top-1/4"/>
        ...
        <div class="mt-12 lg:mt-48 text-small text-justify leading-tight">
          <p >
            <svg id="Isolation_Mode" data-name="Isolation Mode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 19" class="w-[70px] mt-2 mr-4 text-blackColor float-left">
              <g id="Logo">
