  ...
  <div class="flex flex-col">
    <div
      ...
      <div class="flex flex-col container mx-auto relative">
        ...
        <div class="md:w-[62%]">
          <p class="text-[20px] text-justify md:text-[30px] mt-5 lg:mt-10 leading-tight">
            Step into success by becoming an American Health
            Gate Distributor. Access high quality equipment, and
            superior packaging.
          </p>
      ...
      <div class="container mx-auto relative">
        ...
        <div class="flex max-[768px]:hidden flex-wrap items-center justify-center md:justify-between gap-5">
          ...
          <p class="text-[20px] md:text-[30px]  leading-[32px]">
            Experience the evolution with AHG; where quality meets <br class="hidden md:block">
    ...
    <div class="bg-blackColor contact py-[50px] md:py-[100px] flex justify-center items-center">
      <div class="flex flex-col container mx-auto text-white  md:w-[80%]">
        ...
        <form class="mt-12 md:mt-24 grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
