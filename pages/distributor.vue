    ...
    <div class="py-[150px]">
      <div class="container mx-auto relative">
        ...
        <div class="flex items-center justify-between">
          <svg data-name="Isolation Mode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 399.7 228" class="text-blackColor w-[300px]">
        ...
        <div class="mt-48 text-[28px] text-justify leading-tight">
          <p >
