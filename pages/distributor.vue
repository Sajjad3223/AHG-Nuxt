  ...
  <div class="flex flex-col">
    <div class="w-full bg-blackColor flex items-center justify-center h-[90vh] text-white">
      <div class="flex flex-col container mx-auto relative">
        <h1 class="text-[110px]  font-bold leading-[1.2]"
      ...
      <div class="container mx-auto relative">
        ...
        <div class="mt-12 lg:mt-28 text-[28px] leading-[32px] text-justify">
          <p>
            ...
            has traversed an impressive journey, expanding its footprint globally. We take pride in delivering
            premium-quality healthcare devices to consumers across the international market and partnering with
            distributors worldwide.<br>
            
            Our commitment to accuracy and reliability ensures that our products provide exceptional value to our
            clients. With added features and unparalleled durability, the AHG brand guarantees highly satisfactory
            results.
          </p>
          <p class="mt-6 ">
            Customer satisfaction and mutual well-being stand as the cornerstone of our philosophy. These core values
            have positioned us as the preferred choice for numerous businesses in the industry and discerning
            end-consumers alike. At AHG, we continue to strive for excellence, setting the standard for premium
            healthcare devices and solidifying our reputation as a trusted global partner.
          </p>
        </div>
      </div>
    </div>

    <div class="bg-blackColor contact py-[100px] flex justify-center items-center">
      <div class="flex flex-col container mx-auto text-white">
        <h3 class="text-3xl text-center font-bold leading-tight">
          Join our <br>
