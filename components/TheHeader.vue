    ...
    <div class="flex items-center container  py-6">
      ...
      <Transition name="fade-slide">
        <div
          ...
          <ul class=" w-full flex-1 uppercase flex flex-col  divide-y divide-white/40 gap-4 text-xl text-white">
            ...
            <li class="w-full  ">
              <button v-click-outside="() => isOpenProductMenu = false"
                ...
                PRODUCTS
                <svg :class="isOpenMobileProductMenu ? 'rotate-90' : '-rotate-90'" width="18" height="18"
