<template>
  <div>
    ...
    <footer class="pt-[90px] pb-5">
      <div class="container mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 md:gap-5 md:gap-y-10 lg:gap-12">
        <div class="flex flex-col items-start self-start col-span-full lg:col-span-1">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 399.7 228" class="text-blackColor max-w-[200px]">
        ...
        <div class="flex max-w-[210px]  flex-col space-y-4">
        ...
        <div class="flex max-w-[210px] md:justify-self-center flex-col space-y-4">
          <div class="flex items-center gap-4">
        ...
        <div class="flex max-w-[210px] md:justify-self-end flex-col space-y-4">
          <div class="flex items-center gap-4">
