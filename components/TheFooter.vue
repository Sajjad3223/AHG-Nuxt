  ...
  <div>
    ...
    <div class="w-full bg-blackColor min-h-[680px] flex items-center justify-center">
      <div class="container mx-auto flex flex-col">
        ...
        <button class="bg-white rounded-[8px] flex items-center gap-4 w-max px-4 py-2 mt-8">
    ...
    <footer class="pt-[90px] pb-5">
      <div class="container mx-auto grid grid-cols-4 gap-12">
        <div class="flex  flex-col">
          <svg data-name="Isolation Mode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 399.7 228" class="text-blackColor">
        ...
        <div class="flex max-w-[210px] justify-self-end flex-col space-y-4">
          <div class="flex items-center gap-4">
            <svg id="Isolation_Mode" data-name="Isolation Mode" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 19" class="w-[60px] text-blackColor">
              <g id="Logo">
            ...
            <span class="text-[24px]">Healthcare</span>
          </div>
          <hr>
        ...
        <div class="flex max-w-[210px] justify-self-end flex-col space-y-4">
          <div class="flex items-center gap-4">
            <span class="text-[24px]">Our Company</span>
          </div>
          <hr>
          <div class="flex flex-col space-y-3">
        ...
        <div class="flex max-w-[210px] justify-self-end flex-col space-y-4">
          <div class="flex items-center gap-4">
            <span class="text-[24px]">Support</span>
          </div>
          <hr>
          <div class="flex flex-col space-y-3">
      ...
      <div class="container mx-auto flex items-center justify-between">
        <span class="text-[15px]">
          Copyright © 2012-2023 American Health Gate CO., LLC. All rights reserved.
        </span>
        <div class="flex items-center gap-4">
          <div class="w-[70px] h-[70px] grid place-items-center rounded-[20px] bg-blackColor text-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.52 44.41" class="w-[40px]">
              <path fill="currentColor" d="M39.11,0H4.41C1.98,0,0,1.98,0,4.41v35.58c0,2.44,1.98,4.41,4.41,4.41h34.69c2.44,0,4.41-1.98,4.41-4.41V4.41c0-2.44-1.98-4.41-4.41-4.41ZM21.76,14.57c4.35,0,7.87,3.52,7.87,7.87s-3.52,7.87-7.87,7.87-7.87-3.52-7.87-7.87,3.52-7.87,7.87-7.87ZM39.29,34.73c-.02.75-.05,2.59-.92,3.72-1.2,1.56-3.69,1.38-3.96,1.36l-12.6.02h-.1l-12.6-.02c-.27.02-2.76.21-3.96-1.36-.87-1.13-.91-2.97-.92-3.72,0-.15,0-.27,0-.35l-.05-16.82h6.23c-.18.49-2.31,6.67,1.63,11.94.47.63,4.19,4.73,9.72,4.88,5.53-.15,9.25-4.25,9.72-4.88,3.94-5.27,1.8-11.45,1.63-11.94h6.23l-.05,16.82c0,.08,0,.21,0,.35ZM40.01,12.23c0,.28-.23.52-.52.52h-6.47c-.28,0-.52-.23-.52-.52v-6.47c0-.28.23-.52.52-.52h6.47c.28,0,.52.23.52.52v6.47Z"/>
            </svg>
          </div>
          <div class="relative w-[70px] h-[70px] grid place-items-center rounded-[20px] bg-blackColor text-white">
            <strong class="absolute text-[60px] font-['Product Sans'] text-white">in</strong>
          </div>
          <div class="w-[70px] h-[70px] grid place-items-center rounded-[20px] bg-blackColor text-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 35.57" class="w-[40px]">
          ...
          <div class="w-[70px] h-[70px] grid place-items-center rounded-[20px] bg-blackColor text-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.78 43.85" class="w-[20px]">
              <path fill="currentColor" d="M15.23,9.68v5.82l7.56-.05-.72,8.62-6.84.05v19.73H6.48v-19.78H0v-8.57h6.4v-6.57C6.4,4.09,10.32.17,15.15,0h7.6v7.21h-4.95c-1.18.06-2.58.94-2.58,2.47Z"/>
            </svg>
          </div>
          <div class="w-[70px] h-[70px] grid place-items-center rounded-[20px] bg-blackColor text-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.4 31.85" class="w-[40px]">
              <path fill="currentColor" d="M35.14,0H8.26C3.7,0,0,3.7,0,8.26v15.33c0,4.56,3.7,8.26,8.26,8.26h26.88c4.56,0,8.26-3.7,8.26-8.26v-15.33c0-4.56-3.7-8.26-8.26-8.26ZM17.2,22.66v-13.48l12.05,6.74-12.05,6.74Z"/>
            </svg>
          </div>
        </div>
      </div>
